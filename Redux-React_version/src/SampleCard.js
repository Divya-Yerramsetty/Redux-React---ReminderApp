        ...
        return(
            <div className = "reminder-card">
              ...
              <div className="product-action">
                  <button onClick={()=>{ store.dispatch({ type:'DEL_FROM_CART', card: this.props.cardId}) }}  className="delete" type="button"> Forget </button>
              </div> :
              <div className="product-action">
                  <button onClick={()=>{ store.dispatch({ type:'ADD_TO_CART', card: this.props.cardId}) }}  className="added" type="button"> Add to Remind </button>
              </div>  
            }
            </div>
        )
